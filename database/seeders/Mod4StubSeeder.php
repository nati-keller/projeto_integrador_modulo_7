    ...
    private function seedAnalysis(): void
    {
        DB::table('mod4_analysis')->insert([
            ...
            [
                ...
                'financial_summary' => json_encode(['estimativa' => 9.50, 'itens' => 1]),
                'decided_at'        => now(),
                'notes'             => null,
            ...
            [
                ...
                'status'            => 'go',
                'processing_status' => 'done',
                'financial_summary' => json_encode(['estimativa' => 96.60, 'itens' => 1]),
                'decided_at'        => now(),
                'notes'             => null,
                'processing_error'  => null,
                'processed_at'      => now(),
            ...
            [
                ...
                'status'            => 'go',
                'processing_status' => 'done',
                'financial_summary' => json_encode(['estimativa' => 150.00, 'itens' => 1]),
                'decided_at'        => now(),
                'notes'             => null,
                'processing_error'  => null,
                'processed_at'      => now(),
